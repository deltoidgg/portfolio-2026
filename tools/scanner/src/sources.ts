...
export const CALIBRATION_SITES: CalibrationSite[] = [
  ...
  { hostname: "check-mot.service.gov.uk", expected: "adopter", note: "DVSA check MOT" },
  { hostname: "vehicleenquiry.service.gov.uk", expected: "adopter", note: "DVLA vehicle enquiry" },
  {
    hostname: "viewdrivingrecord.service.gov.uk",
    expected: "adopter",
  ...
  { hostname: "petition.parliament.uk", expected: "adopter", note: "Petitions (govuk-frontend)" },
  { hostname: "www.account.gov.uk", expected: "adopter", note: "GOV.UK One Login" },
  ...
  { hostname: "www.parliament.uk", expected: "non-adopter", note: "Parliament DS" },
  { hostname: "www.parliament.scot", expected: "non-adopter", note: "Scottish Parliament" },
  { hostname: "www.senedd.wales", expected: "non-adopter", note: "Senedd" },
  { hostname: "www.met.police.uk", expected: "non-adopter", note: "Met Police" },
  { hostname: "www.bankofengland.co.uk", expected: "non-adopter", note: "Bank of England" },
];
